...
function IssuesPage() {
  ...
  const generateIssuePDF = (issue) => {
    ...
    doc.text("Issue Report", 105, 20, null, null, "center");
    ...
    addRow("Raised By", issue.raisedBy?.username);
    addRow("Raised To", issue.raisedTo?.username);
    addRow(
      "Status",
      issue.resolvedStatus
        ? "Resolved"
        : issue.notedStatus
        ? "Noted"
        : "Pending"
    );
    addRow("Created At", format(new Date(issue.createdAt), "PPP"));

    // Footer
    doc.setFontSize(10);
    doc.setTextColor(150);
    doc.text("Generated by Issue Tracker System", 20, 280);
      ...
      <TableRow key={issue._id}>
        ...
        <TableCell className="flex gap-2">
          <Link href={`/authenticated/common/issues/issueById/${issue._id}`}>
            <Button variant="ghost" size="icon" title="View Issue">
